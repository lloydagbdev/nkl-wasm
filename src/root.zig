...
pub const checkedSliceFromPtrLen = memory.checkedSliceFromPtrLen;
pub const bytesFromPtrLen = memory.bytesFromPtrLen;
pub const checkedBytesFromPtrLen = memory.checkedBytesFromPtrLen;
pub const ptrLen = memory.ptrLen;
...
test {
    ...
    _ = freeBytes;
    _ = sliceFromPtrLen;
    _ = checkedSliceFromPtrLen;
    _ = bytesFromPtrLen;
    _ = checkedBytesFromPtrLen;
    _ = ptrLen;
    _ = log;
    _ = logError;
    _ = logFmt;
